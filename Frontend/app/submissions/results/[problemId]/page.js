...
import ViewProblemResultPage from "@/app/ui/ViewProblemResult/ViewProblemResultPage";

const ViewProblemResult = ({ params }) => {
  ...
  return (
    <Layout
      ...
      userDate={userDate}
    >
      <ViewProblemResultPage id={problemId} />
    </Layout>
  );
};

export default ViewProblemResult;
